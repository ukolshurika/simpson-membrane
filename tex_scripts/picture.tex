  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      axis y line*=left,
        ...
        xmin=-0.1,
        xmax=80]
        \addplot[mark=none, smooth] file {data/cup_stick_h.dat};   % Here is the data file
    \end{axis}
    \begin{axis}[   
      scale only axis,
        ylabel=$\overline{\sigma}_u(t) \cdot 10^3$,
        ...
        xmin=-0.1,
        xmax=80]
      \addplot[mark=none,smooth, dashdotted] file {data/cup_stick_s.dat};   % Here is the data file 
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      axis y line*=left,
        ...
        xmin=-0.1,
        xmax=80]
        \addplot[mark=none, smooth] file {data/cup_stick_h1.dat};   % Here is the data file
    \end{axis}
    \begin{axis}[   
      scale only axis,
        ylabel=$\overline{\sigma}_u(t) \cdot 10^3$,
        ...
        xmin=-0.1,
        xmax=80]
      \addplot[mark=none,smooth, dashdotted] file {data/cup_stick_s1.dat};   % Here is the data file 
      \addplot[mark=none, dotted] coordinates {(7.14, 0) (7.14, 20)}; 
      \addplot[mark=none, dashdotted] coordinates {(57, 17) (70, 17)};
      \addplot[mark=none] coordinates {(57, 18.5) (70, 18.5)};
      \node at (72, 170) {2};
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      axis y line*=left,
        ...
        xmin=-0.1,
        xmax=80]
        \addplot[mark=none, smooth] file {data/cup_stick_h2.dat};   % Here is the data file
    \end{axis}
    \begin{axis}[   
      scale only axis,
        ylabel=$\overline{\sigma}_u(t) \cdot 10^3$,
        ...
        xmin=-0.1,
        xmax=80]
      \addplot[mark=none,smooth, dashdotted] file {data/cup_stick_s2.dat};   % Here is the data file 
      \addplot[mark=none, dotted] coordinates {(7.14, 0) (7.14, 20)}; 
      \addplot[mark=none, dashdotted] coordinates {(57, 17) (70, 17)};
      \addplot[mark=none] coordinates {(57, 18.5) (70, 18.5)};
      \node at (72, 170) {2};
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      axis y line*=left,
        ...
        xmin=-0.1,
        xmax=80]
        \addplot[mark=none, smooth] file {data/cup_stick_h3.dat};   % Here is the data file
    \end{axis}
    \begin{axis}[   
      scale only axis,
        ylabel=$\overline{\sigma}_u(t) \cdot 10^3$,
        ...
        xmin=-0.1,
        xmax=80]
      \addplot[mark=none,smooth, dashdotted] file {data/cup_stick_s3.dat};   % Here is the data file 
      \addplot[mark=none, dotted] coordinates {(7.14, 0) (7.14, 20)}; 
      \addplot[mark=none, dashdotted] coordinates {(57, 17) (70, 17)};
      \addplot[mark=none] coordinates {(57, 18.5) (70, 18.5)};
      \node at (72, 170) {2};

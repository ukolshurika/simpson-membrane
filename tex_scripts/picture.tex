...
\begin{tikzpicture}
  \begin{axis}[
    ...
    axis y line*=left,
      ...
      xmin=-0.1,
      xmax=80]
      \addplot[mark=none, smooth] file {h.out};   % Here is the data file
      \addplot[mark=none, dotted] coordinates {(1.34, 0) (1.31, 1)};   % Here is the data file
  ...
  \begin{axis}[   
    ...
    axis x line=center,
      ...
      xmin=-0.1,
      xmax=80]
    \addplot[mark=none,smooth, dashdotted] file {s.out};   % Here is the data file 

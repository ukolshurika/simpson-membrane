...
\begin{tikzpicture}
  \begin{axis}[
    scale only axis,
      ...
      xtick={1.34,15,22.9,30, 45,...,80},
      ymin=0,
      ymax=1,
      xmin=0,
      xmax=80]
      \addplot[mark=none, smooth] file {data/h05.dat};   % Here is the data file
      %\addplot[mark=none, dotted] coordinates {(22.9, 0) (22.9, 1)};   % Here is the data file
  \end{axis}
  \begin{axis}[   
    scale only axis,
    ...
    axis x line=box,
      ...
      xmin=0,
      xmax=80]
    \addplot[mark=none,smooth, dashdotted] file {data/s05.dat};   % Here is the data file 
    %\addplot[mark=none, dotted] coordinates {(1.34, 0) (1.34, 20)}; 
  ...
  \end{axis}
    ...
    axis x line=box,
      ...
      xmin=0,
      xmax=80]
    \addplot[mark=none,smooth, dashed] file {data/cup_stick_s.dat};   % Here is the data file 
    %\addplot[mark=none, dotted] coordinates {(1.34, 0) (1.34, 20)}; 
    %\addplot[mark=none] coordinates {(60, 16) (60, 19.5) (75, 19.5) (75, 16) (60, 16)};
    \addplot[mark=none, dashdotted] coordinates {(57, 17) (70, 17)};
    \addplot[mark=none] coordinates {(57, 18.5) (70, 18.5)};
  ...
  \end{axis}
    ...
    axis x line=box,
      ...
      xmin=0,
      xmax=80]
    \addplot[mark=none,smooth, densely dotted] file {data/cup_stick_h.dat};   % Here is the data file 
    %\addplot[mark=none, dotted] coordinates {(1.34, 0) (1.34, 20)}; 
    %\addplot[mark=none] coordinates {(60, 16) (60, 19.5) (75, 19.5) (75, 16) (60, 16)};
    \addplot[mark=none, dashdotted] coordinates {(57, 17) (70, 17)};
    \addplot[mark=none] coordinates {(57, 18.5) (70, 18.5)};

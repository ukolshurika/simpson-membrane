...
%    axis y line*=box,
%      ytick={0,0.2,...,0.8, 1},
%      xtick={0, 0.2,0.4,0.632,0.8, 1 },
%      ymin=0,
%      ymax=1,
%      xmin=0,
%      xmax=1]
%      \addplot[mark=none, smooth] file {data/h_by_x.dat};   % Here is the data file
%      \addplot[mark=none, dotted] coordinates {(0.632, 0) (0.632, 1)};   % Here is the data file
%  \end{axis}
% 
%\end{tikzpicture}
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    axis y line*=box,
      ...
      \addplot[mark=none, smooth] file {data/h_by_x.dat};   % Here is the data file
      \addplot[mark=none, dotted] coordinates {(0.632, 0) (0.632, 1)};   % Here is the data file
      \addplot[mark=none, dashed] coordinates {(0, 0.6) (1, 0.6)};   % Here is the data file
      \addplot[mark=none, dashed] coordinates {(0.46, 0.55) (0.77, 0.55)};   % Here is the data file
      \addplot[mark=none, dashed] coordinates {(0.615, 0.5) (0.645, 0.5)};   % Here is the data file
  \end{axis}
